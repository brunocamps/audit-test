...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference("Evaluation.count") do
      post evaluations_url, params: { evaluation: { company_area_id: @evaluation.company_area_id, name: @evaluation.name } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { company_area_id: @evaluation.company_area_id, name: @evaluation.name } }
