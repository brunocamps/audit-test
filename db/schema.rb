...
ActiveRecord::Schema[7.0].define(version: 2023_04_11_161001) do
  ...
  create_table "evaluations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_area_id"], name: "index_evaluations_on_company_area_id"
  end
  ...
  create_table "process_assignments", force: :cascade do |t|
    t.bigint "user_process_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_process_assignments_on_user_id"
    t.index ["user_process_id"], name: "index_process_assignments_on_user_process_id"
  end
  ...
  create_table "user_processes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "auditoria"
    t.text "checklist_ideal"
    t.text "checklist_real"
    t.integer "peso_processo"
  ...
  create_table "verifications", force: :cascade do |t|
    ...
    t.index ["evaluation_id"], name: "index_verifications_on_evaluation_id"
  end
  ...
  add_foreign_key "evaluations", "company_areas"
  add_foreign_key "pay_charges", "pay_customers", column: "customer_id"
  add_foreign_key "pay_payment_methods", "pay_customers", column: "customer_id"
  add_foreign_key "pay_subscriptions", "pay_customers", column: "customer_id"
  add_foreign_key "user_connected_accounts", "users"
  add_foreign_key "users", "company_areas"
  add_foreign_key "verifications", "evaluations"
end
